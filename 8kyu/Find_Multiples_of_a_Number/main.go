...
you will write a function that takes two integers;
n and limit; and returns a list of the multiples of n up to
and possibly including limit.
...
func FindMultiples(integer, limit int) []int {
	...
	for i := 1; i*integer <= limit; i++ {
		numbers = append(numbers, i*integer)
	}
	return numbers
}
